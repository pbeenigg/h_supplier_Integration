package com.heytrip.hotel.supplier.repository.primary;
...
@Repository
@DS("primary")
public interface SupplierConfigRepository extends JpaRepository<SupplierConfig, Long>, JpaSpecificationExecutor<SupplierConfig> {
